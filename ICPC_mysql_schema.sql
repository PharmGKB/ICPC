...
insert into propertyNames(name,descrip,datatype) values ('carat_2micro_aggmax','CARAT TX4 post Plavix loading dose platelet rich plasma max aggregation of ADP 2 然 %', 'string');
