...
CREATE TABLE `samples` (
  ...
  `Genotyping` enum('0','1') NOT NULL,
  `Phenotyping` enum('0','1') NOT NULL,
  `Sample_Source` set('1','2','3','4') DEFAULT NULL,
  ...
  `Diabetes` enum('99','0','1','2') DEFAULT NULL,
  `Ever_Smoked` enum('99','1','2') DEFAULT NULL,
  `Current_smoker` enum('99','1','2') DEFAULT NULL,
  `Alcohol` enum('99','0','1','2','3') DEFAULT NULL,
  `Blood_Pressure` enum('99','0','1') DEFAULT NULL,
  ...
  `Ejection_fraction` enum('0','1') DEFAULT NULL,
  `Left_Ventricle` decimal(10,0) DEFAULT NULL,
  `placebo_RCT` enum('99','0','1') DEFAULT NULL,
  `Clopidogrel` enum('0','1') NOT NULL,
  `Dose_Clopidogrel` decimal(10,0) DEFAULT NULL,
  `Duration_Clopidogrel` decimal(10,0) DEFAULT NULL,
  `Aspirin` enum('0','1') NOT NULL,
  `Dose_Aspirin` decimal(10,0) DEFAULT NULL,
  `Duration_Aspirin` decimal(10,0) DEFAULT NULL,
  `Statins` enum('99','0','1') DEFAULT NULL,
  `PPI` enum('99','0','1') DEFAULT NULL,
  `PPI_name` enum('6','1','2','3','4','5') DEFAULT NULL,
  `Calcium_blockers` enum('99','0','1') DEFAULT NULL,
  `Beta_blockers` enum('99','0','1') DEFAULT NULL,
  `ACE_Inh` enum('99','0','1') DEFAULT NULL,
  `Ang_inh_blockers` enum('99','0','1') DEFAULT NULL,
  `Ezetemib` enum('99','0','1') DEFAULT NULL,
  `Glycoprotein_IIaIIIb_inhibitor` enum('99','0','1') DEFAULT NULL,
  `Active_metabolite` decimal(10,0) DEFAULT NULL,
  `CV_events` enum('99','0','1') DEFAULT NULL,
  `Time_MACE` decimal(10,0) DEFAULT NULL,
  `Bleeding` enum('99','0','1') DEFAULT NULL,
  `Major_Bleeding` enum('99','0','1') DEFAULT NULL,
  `Minor_Bleeding` enum('99','0','1') DEFAULT NULL,
  `Days_MajorBleeding` decimal(10,0) DEFAULT NULL,
  `Days_MinorBleeding` decimal(10,0) DEFAULT NULL,
  `STEMI` enum('99','0','1') DEFAULT NULL,
  `Time_STEMI` decimal(10,0) DEFAULT NULL,
  `NSTEMI` enum('99','0','1') DEFAULT NULL,
  `Time_NSTEMI` decimal(10,0) DEFAULT NULL,
  `Angina` enum('99','0','1') DEFAULT NULL,
  `Time_Angina` decimal(10,0) DEFAULT NULL,
  `REVASC` enum('99','0','1') DEFAULT NULL,
  `Time_REVASC` decimal(10,0) DEFAULT NULL,
  `Stroke` enum('99','0','1') DEFAULT NULL,
  `Time_stroke` decimal(10,0) DEFAULT NULL,
  `Other_ischemic` enum('99','0','1') DEFAULT NULL,
  `Congestive_Heart_Failure` enum('99','0','1') DEFAULT NULL,
  `Time_heartFailure` decimal(10,0) DEFAULT NULL,
  `Mechanical_Valve_Replacement` enum('99','0','1','2') DEFAULT NULL,
  `Time_MechValve` decimal(10,0) DEFAULT NULL,
  `Tissue_Valve_Replacement` enum('99','0','1') DEFAULT NULL,
  `Time_tissValve` decimal(10,0) DEFAULT NULL,
  `Stent_thromb` enum('99','0','1','2') DEFAULT NULL,
  `Time_stent` decimal(10,0) DEFAULT NULL,
  `All_cause_mortality` enum('99','0','1') DEFAULT NULL,
  `Time_mortality` decimal(10,0) DEFAULT NULL,
  `Cardiovascular_death` enum('99','0','1') DEFAULT NULL,
  `Time_death` decimal(10,0) DEFAULT NULL,
  `Left_ventricular_hypertrophy` enum('99','0','1') DEFAULT NULL,
  `Time_venHypertrophy` decimal(10,0) DEFAULT NULL,
  `Peripheral_vascular_disease` enum('99','0','1') DEFAULT NULL,
  `Time_PeriVascular` decimal(10,0) DEFAULT NULL,
  `Atrial_fibrillation` enum('99','0','1') DEFAULT NULL,
  `Time_AF` decimal(10,0) DEFAULT NULL,
  `Duration_followup_clinical_outcomes` decimal(10,0) DEFAULT NULL,
  `Blood_Cell` enum('99','0','1') DEFAULT NULL,
  ...
  `Verify_Now_base` enum('0','1') DEFAULT NULL,
  `Verify_Now_post_loading` enum('0','1') DEFAULT NULL,
  `Verify_Now_while_on_clopidogrel` enum('0','1') DEFAULT NULL,
  `Optical_Platelet_Aggregometry` decimal(10,0) DEFAULT NULL,
  `Pre_clopidogrel_platelet_aggregometry_base` enum('0','1') DEFAULT NULL,
  `Post_clopidogrel_platelet_aggregometry` enum('0','1') DEFAULT NULL,
