...
insert into propertyNames(name,descrip,datatype) values ('Genotyping','Genetic Sample Available for GWAS & Genotyping QC (> 2 �g)','number');
...
insert into propertyNames(name,descrip,datatype) values ('White_cell_count','Absolute White cell count (cells/�L)','number');
insert into propertyNames(name,descrip,datatype) values ('Red_cell_count','Red cell count (cells/�L)','number');
insert into propertyNames(name,descrip,datatype) values ('Platelet_count','Platelet count (cells/�L)','number');
...
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_max_ADP_2','PAP-8 baseline platelet rich plasma max aggregation of ADP 2 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_max_ADP_5','PAP-8 baseline platelet rich plasma max aggregation of ADP 5 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_max_ADP_10','PAP-8 baseline platelet rich plasma max aggregation of ADP 10 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_max_ADP_20','PAP-8 baseline platelet rich plasma max aggregation of ADP 20 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_max_collagen_1','PAP-8 baseline platelet rich plasma max aggregation of Collagen 1 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_max_collagen_2','PAP-8 baseline platelet rich plasma max aggregation of Collagen 2 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_max_collagen_10','PAP-8 baseline platelet rich plasma max aggregation of Collagen 5 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_max_collagen_6','PAP-8 baseline platelet rich plasma max aggregation of Collagen 10 �g/ml%','number');
...
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_lag_collagen_1','PAP-8 baseline platelet rich plasma lag time of Collagen 1 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_lag_collagen_2','PAP-8 baseline platelet rich plasma lag time of Collagen 2 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_lag_collagen_5','PAP-8 baseline platelet rich plasma lag time of Collagen 5 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_baseline_lag_collagen_10','PAP-8 baseline platelet rich plasma lag time of Collagen 10 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_max_ADP_2','PAP-8 post Plavix loading dose platelet rich plasma max aggregation of ADP 2 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_max_ADP_5','PAP-8 post Plavix loading dose platelet rich plasma max aggregation of ADP 5 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_max_ADP_10','PAP-8 post Plavix loading dose platelet rich plasma max aggregation of ADP 10 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_max_ADP_20','PAP-8 post Plavix loading dose platelet rich plasma max aggregation of ADP 20 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_max_collagen_1','PAP-8 post Plavix loading dose platelet rich plasma max aggregation of Collagen 1 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_max_collagen_2','PAP-8 post Plavix loading dose platelet rich plasma max aggregation of Collagen 2 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_max_collagen_5','PAP-8 post Plavix loading dose platelet rich plasma max aggregation of Collagen 5 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_max_collagen_10','PAP-8 post Plavix loading dose platelet rich plasma max aggregation of Collagen 10 �g/ml%','number');
...
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_lag_collagen_1','PAP-8 post Plavix loading dose platelet rich plasma lag time of Collagen 1 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_lag_collagen_2','PAP-8 post Plavix loading dose platelet rich plasma lag time of Collagen 2 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_lag_collagen_5','PAP-8 post Plavix loading dose platelet rich plasma lag time of Collagen 5 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_post_lag_collagen_10','PAP-8 post Plavix loading dose platelet rich plasma lag time of Collagen 10 �g/ml%','number');
...
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_max_ADP_2','PAP-8 maintenance dose of clopidogrel platelet rich plasma max aggregation of ADP 2 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_max_ADP_5','PAP-8 maintenance dose of clopidogrel platelet rich plasma max aggregation of ADP 5 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_max_ADP_10','PAP-8 maintenance dose of clopidogrel platelet rich plasma max aggregation of ADP 10 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_max_ADP_20','PAP-8 maintenance dose of clopidogrel platelet rich plasma max aggregation of ADP 20 �M %','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_max_collagen_1','PAP-8 maintenance dose of clopidogrel platelet rich plasma max aggregation of Collagen 1 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_max_collagen_2','PAP-8 maintenance dose of clopidogrel platelet rich plasma max aggregation of Collagen 2 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_max_collagen_5','PAP-8 maintenance dose of clopidogrel platelet rich plasma max aggregation of Collagen 5 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_max_collagen_10','PAP-8 maintenance dose of clopidogrel platelet rich plasma max aggregation of Collagen 10 �g/ml%','number');
...
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_lag_collagen_1','PAP-8 maintenance dose of clopidogrel platelet rich plasma lag time of Collagen 1 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_lag_collagen_2','PAP-8 maintenance dose of clopidogrel platelet rich plasma lag time of Collagen 2 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('5PAP_8_standard_lag_collagen_5','PAP-8 maintenance dose of clopidogrel platelet rich plasma lag time of Collagen 5 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('PAP_8_standard_lag_collagen_10','PAP-8 maintenance dose of clopidogrel platelet rich plasma lag time of Collagen 10 �g/ml%','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_baseline_max_ADP_5','Chronolog baseline whole blood max aggregation of ADP 5 �M in ohms','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_baseline_max_ADP_20','Chronolog baseline whole blood max aggregation of ADP 20 �M in ohms','number');
...
insert into propertyNames(name,descrip,datatype) values ('Chronolog_baseline_max_collagen1','Chronolog baseline whole blood max aggregation of Collagen 1 �g/mlin ohms','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_baseline_lag_ADP_5','Chronolog baseline whole blood lag time of ADP 5 �g/mlin seconds','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_baseline_lag_ADP_20','Chronolog baseline whole blood lag time of ADP 20 �g/mlin seconds','number');
...
insert into propertyNames(name,descrip,datatype) values ('Chronolog_baseline_lag_collagen1','Chronolog baseline whole blood lag time of Collagen 1 �g/mlin seconds','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_loading_max_ADP_5','Chronolog Plavix post loading dose whole blood max aggregation of ADP 5 �M in ohms','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_loading_max_ADP_20','Chronolog Plavix post loading dose whole blood max aggregation of ADP 20 �M in ohms','number');
...
insert into propertyNames(name,descrip,datatype) values ('Chronolog_loading_max_collagen1','Chronolog Plavix post loading dose whole blood max aggregation of Collagen 1 �g/mlin ohms','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_loading_lag_ADP_5','Chronolog Plavix post loading dose whole blood lag time of ADP 5 �M in seconds','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_loading_lag_ADP_20','Chronolog Plavix post loading dose whole blood lag time of ADP 20 �M in seconds','number');
...
insert into propertyNames(name,descrip,datatype) values ('Chronolog_loading_lag_collagen1','Chronolog Plavix post loading dose whole blood lag time of Collagen 1 �g/mlin seconds','number');
...
insert into propertyNames(name,descrip,datatype) values ('Chronolog_standard_max_ADP_5','Chronolog Plavix maintenance dose whole blood max aggregation of ADP 5 �M in ohms','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_standard_max_ADP_20','Chronolog Plavix maintenance dose whole blood max aggregation of ADP 20 �M in ohms','number');
...
insert into propertyNames(name,descrip,datatype) values ('Chronolog_standard_max_collagen1','Chronolog Plavix maintenance dose whole blood max aggregation of Collagen 1 �g/mlin ohms','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_standard_lag_ADP_5','Chronolog Plavix maintenance dose whole blood lag time of ADP 5 �M in seconds','number');
insert into propertyNames(name,descrip,datatype) values ('Chronolog_standard_lag_ADP_20','Chronolog Plavix maintenance dose whole blood lag time of ADP 20 �M in seconds','number');
...
insert into propertyNames(name,descrip,datatype) values ('Chronolog_standard_lag_collagen1','Chronolog Plavix maintenance dose whole blood lag time of Collagen 1 �g/mlin seconds','number');
...
insert into propertyNames(name,descrip,datatype) values ('Abs_white_on_plavix','Absolute White cell count (cells/�L) on Plavix','number');
insert into propertyNames(name,descrip,datatype) values ('Red_on_plavix','Red cell count (cells/�L) on Plavix','number');
insert into propertyNames(name,descrip,datatype) values ('Platelet_on_plavix','Platelet count (cells/�L) on Plavix','number');
...
insert into propertyNames(name,descrip,datatype) values ('carat_2micro_aggmax','CARAT TX4 post Plavix loading dose platelet rich plasma max aggregation of ADP 2 �M %', 'string');
