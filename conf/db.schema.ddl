...
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs7254579', 'CYP2B6 genotype T>C (rs7254579)', 'string', 'C/C, C/T, T/T, NA', 291);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs2286823', 'TMEM120A; POR genotype G>A (rs2286823)', 'string', 'A/A, A/G, G/G, NA', 292);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs1057868', 'TMEM120A; POR genotype C>T (rs1057868)', 'string', 'C/C, C/T, T/T, NA', 293);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs2046934', 'MED12L;P2RY12 genotype A>G  (rs2046934)', 'string', 'A/A, A/G, G/G, NA', 294);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs1472122', 'P2RY13;MED12L;GPR87  genotype G>A (rs1472122)', 'string', 'A/A, A/G, G/G, NA', 295);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs1799853', 'CYP2C9 genotype C>T (rs1799853)', 'string', 'C/C, C/T, T/T, NA', 296);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs28371685', 'CYP2C9 genotype C>T (rs28371685)', 'string', 'C/C, C/T, T/T, NA', 297);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs28365085', 'CYP3A5 genotype A>G (rs28365085)', 'string', 'A/A, A/G, G/G, NA', 298);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs12041331', 'PEAR1 genotype G>A (rs12041331)', 'string', 'A/A, A/G, G/G, NA', 299);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs1128503', 'ABCB1 genotype G>A (rs1128503)', 'string', 'A/A, A/G, G/G, NA', 300);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs168753', 'F2R genotype A>T (rs168753)', 'string', 'A/A, A/T, T/T, NA', 301);
INSERT INTO propertynames (name, descrip, datatype, format, idx) VALUES ('rs5918', 'ITGB3 genotype T>C (rs5918)', 'string', 'C/C, C/T, T/T, NA', 302);
