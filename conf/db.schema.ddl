...
insert into propertyNames (name, descrip, datatype, format) values ('Age', 'Age at Time of Consent', 'number', 'age reported in years or unknown = NA ');
...
insert into propertyNames (name, descrip, datatype, format) values ('Diabetes', 'Diabetes status', 'number', 'Type 1 Diabetes = 1, Type 2 Diabetes = 2, not present = 0 or not known = NA');
insert into propertyNames (name, descrip, datatype, format) values ('Ever_Smoked', 'Ever Smoked', 'number', 'yes = 1, no = 0 or not known = NA');
insert into propertyNames (name, descrip, datatype, format) values ('Current_smoker', 'Current smoker', 'number', 'yes = 1, not present = 0 or not known = NA');
insert into propertyNames (name, descrip, datatype, format) values ('Blood_Pressure', 'Blood Pressure/Hypertension (required for minimal dataset)', 'number', 'yes = 1, not present = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('placebo_RCT', 'Availability of platelet aggregation or clinical outcomes from the placebo arm of RCTs for analysis of effect modification (not part of minimal dataset)', 'number', 'yes = 1, not present = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Statins', 'Statins', 'number', 'yes=1, no=0, or not known=NA');
insert into propertyNames (name, descrip, datatype, format) values ('PPI', 'PPIs', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Calcium_blockers', 'Calcium Channel Blockers', 'number', 'yes = 1, no = 0 or not known = NA');
insert into propertyNames (name, descrip, datatype, format) values ('Beta_blockers', 'Beta Blockers', 'number', 'yes = 1, no = 0 or not known = NA');
insert into propertyNames (name, descrip, datatype, format) values ('ACE_Inh', 'ACE Inhibitors', 'number', 'yes = 1, no = 0 or not known = NA');
insert into propertyNames (name, descrip, datatype, format) values ('Ang_inh_blockers', 'Angiotensin receptor blockers', 'number', 'yes = 1, no = 0 or not known = NA');
insert into propertyNames (name, descrip, datatype, format) values ('Ezetemib', 'Ezetemib', 'number', 'yes = 1, no = 0 or not known = NA');
insert into propertyNames (name, descrip, datatype, format) values ('Glycoprotein_IIaIIIb_inhibitor', 'Glycoprotein IIa IIIb inhibitor use (required)', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Bleeding', 'Bleeding/Other adverse events reporting', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Minor_Bleeding', 'Minor Bleeding Events', 'number', 'yes = 1, no = 0 or not known = NA;  Any bleed that is not a major bleed');
insert into propertyNames (name, descrip, datatype, format) values ('CV_events', 'Cardiovascular events during followup', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('STEMI', 'STEMI during follow up', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('NSTEMI', 'NSTEMI during follow up', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Stroke', 'ischemic CVA (stroke) during follow up', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Other_ischemic', 'Other ischemic events during follow up', 'number', 'yes = 1, no = 0 or not known = NA');
insert into propertyNames (name, descrip, datatype, format) values ('Congestive_Heart_Failure', 'Congestive Heart Failure and/or Cardiomyopathy duing follow up', 'number', 'yes = 1, not present = 0 or not known = NA ');
...
insert into propertyNames (name, descrip, datatype, format) values ('Mechanical_Valve_Replacement', 'Mechanical Valve Replacement duing follow up', 'number', 'yes = 1, not present = 0, not known = NA or valve replacement but type not known = 2');
...
insert into propertyNames (name, descrip, datatype, format) values ('Tissue_Valve_Replacement', 'Tissue Valve Replacement duing follow up', 'number', 'yes = 1, not present = 0, not known = NA or valve replacement but type not known = 2');
...
insert into propertyNames (name, descrip, datatype, format) values ('Stent_thromb', 'Stent Thrombosis duing follow up', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('All_cause_mortality', 'All cause mortality duing follow up', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Cardiovascular_death', 'Cardiovascular death (well adjudicated by committee independent of physician in charge) duing follow up', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Atrial_fibrillation', 'Atrial fibrillation duing follow up', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Left_ventricular_hypertrophy', 'Left ventricular hypertrophy duing follow up (optional)', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Peripheral_vascular_disease', 'Peripheral vascular disease duing follow up (optional)', 'number', 'yes = 1, no = 0 or not known = NA');
...
insert into propertyNames (name, descrip, datatype, format) values ('Blood_Cell', 'Blood cell count (white and red) (Optional)', 'number', 'yes=1, no=0, or not known=NA');
insert into propertyNames (name, descrip, datatype, format) values ('Chol', 'Various cholesterol measurement (e.g. total, LDL, HDL, etc.) (Required)', 'number', 'yes=1, no=0, or not known=NA');
