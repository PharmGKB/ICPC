...
public enum Property implements ExtendedEnum {
  ...
  ADP               (106, "ADP", "ADP", false, null),
  ARACHADONIC_ACID  (107, "Arachadonic_acid", "Arachadonic acid", false, null),
  COLLAGEN          (108, "Collagen", "Collagen", false, null),
  ...
  CHRONOLOG_BASELINE_LTA_MAX(220, "chronolog_postloading_lta_max", "Chronolog post-loading LTA max aggregation of ADP 20 ug/ml in %", false, IcpcUtils.VALIDATOR_NUMBER),
  ...
  RS3745274         (214, "CYP2B6_6", "CYP2B6*6 genotype G>T (rs3745274)", false, IcpcUtils.VALIDATOR_BASES),
  RS3745274_CYP2B6_9(264, "CYP2B6_9", "CYP2B6*9 genotype G>T (rs3745274)", false, IcpcUtils.VALIDATOR_BASES),
  ...
  PHENO_RAW         (309, "raw_ADP_pheno", "raw_ADP_pheno", false, IcpcUtils.VALIDATOR_NUMBER),
  PHENO_STD         (310, "std_ADP_pheno", "Standardized Top ranking ADP phenotype from each site (does not consider multiple phenotypes from sites)", false, IcpcUtils.VALIDATOR_NUMBER),
